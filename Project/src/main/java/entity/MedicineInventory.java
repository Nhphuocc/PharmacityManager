...
public class MedicineInventory {
	...
	public MedicineInventory(int idSupply, int idSupplier, String iNNCode, LocalDate supply_date,
			LocalDate productionDate, LocalDate expirationDate, int quantityBox, int quantityPelletsIn1Box,
			double costPrice, int idMedin, double sellingPrice, int idUnit, int quantity, String status) {
